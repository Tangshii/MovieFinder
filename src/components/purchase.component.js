...
export default class Purchase extends Component {
  ...
  render() {
    return (
     ...
     <input type="text" class="form-control" id="card" value={this.state.cardnum}
     onChange={this.onChangeCardNum}/>

     </div>
     <div className="form-group">
     <label>Expiration Date (MM/YY): </label>
     <input type="text" class="form-control" id="card" placeholder="MM/YY" value={this.state.expiration}
     onChange={this.onChangeExpiration}/>

     <div className="form-group">
     <label>CVV number: </label>
     <input type="text" class="form-control" id="ccvv" placeholder="" value={this.state.CVV}
